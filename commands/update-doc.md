...
.agent
  ...
  - System: Document the current state of the system (project structure, tech stack, integration points, database schema, and core functionalities such as agent architecture, LL layer, etc.)
...
-   Then update the README. md, make sure you include an index of all documentation created in •agent, so anyone can just look at READMEmd to get full understanding of where to look for what information
...
-   In the end, always update the READMEmd too to include an index of all documentation files
